...
class PreviewPanel(QGroupBox):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self._prev_button.clicked.connect(self._show_previous_image)
        self._next_button = QPushButton("Next")
        self._next_button.clicked.connect(self._show_next_image)
    ...
    def set_render_busy(self, busy: bool) -> None:
        ...
        self._prev_button.setEnabled(not busy and self._can_go_previous())
        self._next_button.setEnabled(not busy and self._can_go_next())
    ...
    def _rebuild_thumbnails(self) -> None:
        ...
        self._prev_button.setVisible(len(self._image_paths) > 1)
        self._next_button.setVisible(len(self._image_paths) > 1)
    ...
    def _update_navigation_state(self) -> None:
        ...
        self._prev_button.setEnabled(has_multiple and self._can_go_previous())
        self._next_button.setEnabled(has_multiple and self._can_go_next())
