...
| **Single-card archive (YYYY-MM-DD)** | Standalone done card → archived | Agent | gel5 user `archive @card` | Card in `done/`; `move_kanban_card.py --to archived` | gel3 batch; Card Done | any label in `done/` | `move_kanban_card.py` |
